...
const committees: Committee[] = [
  {
    ...
    members: [
      ...
      {
        sno: 2,
        name: "Dr. Ganesh Shankar",
        designation: "Member",
        mobile: "7398705464",
      },
      {
        sno: 3,
        name: "Dr. Brijesh Shukla",
        designation: "Member",
        mobile: "9956900650",
      },
      {
        sno: 4,
        name: "Dr. Dependra Gautam",
        designation: "Member",
        mobile: "9198342902",
      },
      {
        sno: 5,
        name: "Smt. Pratibha Sharma",
        designation: "Member",
        mobile: "9984763086",
      },
    ],
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            ...
            well-equipped laboratories, a comprehensive library, sports
            facilities, and spacious classrooms. We believe in nurturing not
            just academic excellence but also the overall personality
          ...
          >
            Located in Karwi Pahadi Road, Khatwara, Rajapur Chitrakoot, we serve
